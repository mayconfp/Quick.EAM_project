...
def gerar_resposta_openai(user_message, contexto=None):
    ...
    messages = [
        {"role": "system", "content": "Você é a IA Manuelo, um assistente virtual especializado na empresa QuickEAM, mas também pode responder perguntas gerais sobre diversos temas."},
